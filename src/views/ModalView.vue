<template lang="pug">
  div
    ...
    modal(v-if="isModalVisible" @close="toggleModal")
      ...
      template(slot="main" id="modalMain")
        textarea#modalNotes(placeholder='e.g: Tell us about the modal body' rows='7' v-model='notes')
      template(slot='footer')
        button.btn-blue(type='button' @click='save' aria-label='Close modal') SAVE
</template>
